...
# Bootimage
BOARD_BOOTIMAGE_PARTITION_SIZE := $(shell echo $$((32 * 1048576))) # 32MB

# System partition definitions
BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_SYSTEMIMAGE_PARTITION_SIZE := $(shell echo $$((2048 * 1048576))) # 2048MB
BOARD_SYSTEMIMAGE_JOURNAL_SIZE := 0
BOARD_SYSTEMIMAGE_EXTFS_INODE_COUNT := 4096

# Vendor partition definitions
TARGET_COPY_OUT_VENDOR := vendor
BOARD_VENDORIMAGE_PARTITION_SIZE := $(shell echo $$((256 * 1048576))) # 256MB
